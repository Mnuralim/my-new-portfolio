  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="flex flex-col items-center gap-3 text-center py-2">
        ...
        <div>
          <h3 className="text-meta-lg font-bold text-[#111111] dark:text-[#f0f0f0]">{title}</h3>
          <p className="text-meta-sm text-[#6b6b66] dark:text-[#999999] mt-1.5 leading-relaxed">
            {description}
          </p>
        </div>
        ...
        <div className="flex gap-2 mt-3 w-full">
          <button
            ...
            onClick={onClose}
            disabled={isPending}
            className="flex-1 px-4 py-2.5 text-meta-sm tracking-widest border-2 border-[#1a1a1a] dark:border-[#2a2a2a] text-[#6b6b66] dark:text-[#999999] hover:border-white hover:text-[#111111] dark:hover:text-[#f0f0f0] transition-colors disabled:opacity-50"
          >
            {cancelLabel}
          </button>
