  ...
  return (
    <>
      <div className="mt-8 mb-6">
        ...
        <div className="flex gap-6 text-meta-xs text-[#6b6b66] dark:text-[#999999] tracking-[1px] flex-wrap">
          <span>{post.date}</span>
      ...
      {post.coverImage && (
        ...
        <img
          src={post.coverImage}
          alt={post.title}
          className="w-full border-2 border-[#1a1a1a] dark:border-[#2a2a2a] mb-10 object-cover"
        />
      )}

      <div className="prose-blog text-meta-lg text-[#6b6b66] dark:text-[#999999] leading-[1.9]">
